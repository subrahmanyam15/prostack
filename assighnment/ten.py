#Display Only Red and White Cars  Use filter() to display cars whose colour is either red or white. 
cars=[
...
print(list(filter(lambda car:car ['color'] == 'Red' and 'White',cars)))